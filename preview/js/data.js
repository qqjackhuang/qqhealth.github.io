window.QINQING_SEED = {
  ...
  services: [
    { id: 's1', name: '预约探望', desc: '登记探访时间，前台引导入户', price: '免费', duration: '需提前 2 小时' },
    { id: 's2', name: '营养配餐', desc: '按医嘱调整低盐低糖餐', price: '18 元/餐起', duration: '当日 10:00 前' },
    { id: 's3', name: '房间打扫', desc: '更换床单、通风除尘', price: '40 元/次', duration: '约 40 分钟' },
    { id: 's4', name: '陪诊就医', desc: '管家陪同往返社区医院', price: '80 元/次', duration: '约 3 小时' },
    { id: 's5', name: '康复护理', desc: '血压监测与关节活动操', price: '60 元/次', duration: '约 45 分钟' },
    { id: 's6', name: '兴趣活动', desc: '书法、合唱、园艺报名', price: '免费', duration: '每周固定' }
  ],
  bookings: [],
  activities: [
